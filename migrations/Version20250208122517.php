 ...
 */
final class Version20250208122517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP ensemble_photos, CHANGE desc_a desc_a LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD ensemble_photos LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE desc_a desc_a VARCHAR(255) NOT NULL');
    }
}
