 ...
 */
final class Version20250206082831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, type_e VARCHAR(255) NOT NULL, info_e VARCHAR(255) NOT NULL, date_e DATE NOT NULL, photo_e VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE galerie (id INT AUTO_INCREMENT NOT NULL, nom_g VARCHAR(255) NOT NULL, photo_g VARCHAR(255) NOT NULL, desc_g VARCHAR(255) NOT NULL, type_g VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
